...
<div class="Register_form" style ="margin-top: 10%;">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="FullName" placeholder="Ex: Vishnu" style="width: 400px;">
    </div>
    <div class="mb-3">
    ...
    <button class="btn" onclick="Registration()">SignUp</button>
...
<div class="Login_form">
    ...
    <button type="button" class="btn btn-link" onclick="toggleToRegistrationForm()"><strong>SignUp</strong></button>
</div>
</div>
</div>
<script>
            ...
            success: function (response) {
                ...
                if (response) {
                    ...
                    if (response.status == 'success') {
                        ...
                        Swal.fire('Error', 'Email ID is already taken!!', 'error');
                    } else {
